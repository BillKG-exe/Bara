...
import './resumeContainerInput.css'
import DeleteIcon from '@material-ui/icons/Delete'
import SpaceDivider from '../customTags/SpaceDivider'

export class ResumeContainerInput extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <div className="education-input-section" id={this.state.id}>
                ...
                <div className="expirence-description">
...
export default ResumeContainerInput
